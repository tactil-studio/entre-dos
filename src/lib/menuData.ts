...
const esTablas: MenuSection = {
	...
	items: [
		...
		{ name: "Tabla de quesos", price: "€13,50" },
		{ name: "Tabla de embutidos", price: "€13,50" },
		{
...
export const cartaEsSections: MenuSection[] = [
	...
	},
	{
		...
		items: [
			...
			{ name: "Wok de verduras", price: "€7,90" },
			{
...
const caTaules: MenuSection = {
	title: "Taules",
	items: [
		{ name: "Pernil ibèric", price: "€13,50" },
		{ name: "Taula de formatges", price: "€13,50" },
		{ name: "Taula d'embotits", price: "€13,50" },
		{
...
export const cartaCaSections: MenuSection[] = [
	{
		...
		items: [
			...
			{
				name: "Montadito de pernil del país, rúcula, parmesà i oli balsàmic caramel·litzat",
				price: "€2,80",
			},
			{
				name: "Montadito de formatge brie, mermelada de tomàquet i ametlles llaminades",
				price: "€2,80",
			},
			{
				name: "Montadito de salmó fumat amb formatge crema i tomàquet cherri",
				price: "€2,80",
			},
	...
	},
	{
		...
		items: [
			...
			{ name: "Wok de verdures", price: "€7,90" },
			{
...
const frPlanches: MenuSection = {
	title: "Planches",
	items: [
		{ name: "Jambon Ibérique", price: "€13,50" },
		{ name: "Planche de fromages", price: "€13,50" },
		{ name: "Planche de charcuterie", price: "€13,50" },
		{
...
export const cartaFrSections: MenuSection[] = [
	...
	},
	{
		...
		items: [
			...
			{ name: "Wok de légumes", price: "€7,90" },
			{
...
const enPlatters: MenuSection = {
	...
	items: [
		{ name: "Jamón ibérico", price: "€13,50" },
		{ name: "Cheese platter", price: "€13,50" },
		{ name: "Charcuterie platter", price: "€13,50" },
		{
...
export const cartaEnSections: MenuSection[] = [
	...
	},
	{
		...
		items: [
			...
			{ name: "Asian stir-fried vegetables", price: "€7,90" },
			{
...
const brunchExtrasEs: MenuSection = {
	...
	layout: "extras-grid",
	items: [
		{ name: "Huevo ecológico pochado", price: "2,50€" },
		{ name: "Pan de pita", price: "2,50€" },
		{ name: "Salmón ahumado", price: "2,50€" },
		{ name: "Bacon", price: "2,50€" },
		{ name: "Jamón del país", price: "2,50€" },
		{ name: "Baba Ganoush", price: "2,50€" },
		{ name: "Hummus", price: "2,50€" },
		{ name: "Salsa tzatziki", price: "2,50€" },
	],
};
...
export const brunchEsSections: MenuSection[] = [
	{
		...
		items: [
			{
				name: "Eggs Benedict",
				desc: "Huevos benedictinos sobre muffin inglés con bacon y salsa holandesa",
				price: "11,90€",
			},
			{
				name: "Eggs Florentine",
				desc: "Huevos benedictinos sobre muffin inglés con espinacas y salsa holandesa. Añadir salmón ahumado: 2,80€",
				price: "11,90€",
			},
			{
				name: "Huevos revueltos",
				desc: "Tres huevos ecológicos revueltos con jamón serrano, espárragos y tostada blanca con semillas",
				price: "11,50€",
			},
			{
				name: "Shakshuka",
				desc: "Shakshuka al horno con huevos ecológicos, tomates, garbanzos, pimientos, cebolla, queso feta y cilantro",
				price: "11,50€",
			},
			{
				name: "Baba Ganoush en tostada",
				desc: "Baba Ganoush tradicional con berenjena asada, granada, yogur, menta y tahini sobre tostada blanca con semillas",
				price: "10,90€",
			},
			{
				name: "Aguacate en tostada",
				desc: "Tostada blanca con semillas, aguacate laminado, tomates cherry y aceite de oliva virgen extra. Añadir jamón serrano: 1,50€",
				price: "10,90€",
			},
			{
				name: "Breakfast tacos",
				desc: "Huevos revueltos con aguacate, cebolla encurtida, tomate, lima y crema agria de jalapeño",
				price: "11,50€",
			},
			{
				name: "Tortitas",
				desc: "Con frutas frescas y sirope de arce",
				price: "10,50€",
			},
		],
	},
...
const brunchExtrasEn: MenuSection = {
	...
	layout: "extras-grid",
	items: [
		{ name: "Organic poached egg", price: "2,50€" },
		{ name: "Pita bread", price: "2,50€" },
		{ name: "Smoked salmon", price: "2,50€" },
		{ name: "Bacon", price: "2,50€" },
		{ name: "Spanish ham", price: "2,50€" },
		{ name: "Baba Ganoush", price: "2,50€" },
		{ name: "Hummus", price: "2,50€" },
		{ name: "Tzatziki sauce", price: "2,50€" },
	],
};
...
export const brunchEnSections: MenuSection[] = [
	{
		...
		items: [
			{
				name: "Eggs Benedict",
				desc: "Eggs benedict on English muffins with bacon and hollandaise sauce",
				price: "11,90€",
			},
			{
				name: "Eggs Florentine",
				desc: "Eggs benedict on English muffins with spinach and hollandaise sauce. Add smoked salmon: 2,80€",
				price: "11,90€",
			},
			{
				name: "Scrambled Eggs",
				desc: "Three organic scrambled eggs with Spanish ham, asparagus and seeded white toast",
				price: "11,50€",
			},
			{
				name: "Shakshuka",
				desc: "Ovenbaked Shakshuka packed with organic eggs, tomatoes, chickpeas, peppers, onion, feta cheese and coriander",
				price: "11,50€",
			},
			{
				name: "Baba Ganoush on toast",
				desc: "Traditional Baba Ganoush with roasted eggplant, pomegranate, yoghurt, mint, tahini on seeded white toast",
				price: "10,90€",
			},
			{
				name: "Avocado on toast",
				desc: "Seeded white toast with sliced avocado, cherry tomatoes and organic olive oil. Add Spanish ham: 1,50€",
				price: "10,90€",
			},
			{
				name: "Breakfast tacos",
				desc: "Scrambled eggs with avocado, pickled onion, tomato, lime and jalapeño sour cream",
				price: "11,50€",
			},
			{
				name: "Pancakes",
				desc: "With fresh fruits and maple syrup",
				price: "10,50€",
			},
		],
	},
...
const brunchExtrasCa: MenuSection = {
	...
	layout: "extras-grid",
	items: [
		{ name: "Ou ecològic escalfat", price: "2,50€" },
		{ name: "Pa de pita", price: "2,50€" },
		{ name: "Salmó fumat", price: "2,50€" },
		{ name: "Bacon", price: "2,50€" },
		{ name: "Pernil del país", price: "2,50€" },
		{ name: "Baba Ganoush", price: "2,50€" },
		{ name: "Hummus", price: "2,50€" },
		{ name: "Salsa tzatziki", price: "2,50€" },
	],
...
export const brunchCaSections: MenuSection[] = [
	{
		...
		items: [
			{
				name: "Eggs Benedict",
				desc: "Ous benedictins sobre muffin anglès amb bacon i salsa holandesa",
				price: "11,90€",
			},
			{
				name: "Eggs Florentine",
				desc: "Ous benedictins sobre muffin anglès amb espinacs i salsa holandesa. Afegir salmó fumat: 2,80€",
				price: "11,90€",
			},
			{
				name: "Ous remenats",
				desc: "Tres ous ecològics remenats amb pernil serrano, espàrrecs i torrada blanca amb llavors",
				price: "11,50€",
			},
			{
				name: "Shakshuka",
				desc: "Shakshuka al forn amb ous ecològics, tomàquets, cigrons, pebrots, ceba, formatge feta i coriandre",
				price: "11,50€",
			},
			{
				name: "Baba Ganoush en torrada",
				desc: "Baba Ganoush tradicional amb albergínia rostida, magrana, iogurt, menta i tahini sobre torrada blanca amb llavors",
				price: "10,90€",
			},
			{
				name: "Alvocat en torrada",
				desc: "Torrada blanca amb llavors, alvocat laminat, tomàquets cherry i oli d'oliva verge extra. Afegir pernil serrano: 1,50€",
				price: "10,90€",
			},
			{
				name: "Breakfast tacos",
				desc: "Ous remenats amb alvocat, ceba encurtida, tomàquet, llima i crema agra de jalapeño",
				price: "11,50€",
			},
			{
				name: "Creps",
				desc: "Amb fruites fresques i xarop d'auró",
				price: "10,50€",
			},
		],
	},
...
const brunchExtrasFr: MenuSection = {
	...
	layout: "extras-grid",
	items: [
		{ name: "Œuf poché biologique", price: "2,50€" },
		{ name: "Pain pita", price: "2,50€" },
		{ name: "Saumon fumé", price: "2,50€" },
		{ name: "Bacon", price: "2,50€" },
		{ name: "Jambon du pays", price: "2,50€" },
		{ name: "Baba Ganoush", price: "2,50€" },
		{ name: "Houmous", price: "2,50€" },
		{ name: "Sauce tzatziki", price: "2,50€" },
	],
};
...
export const brunchFrSections: MenuSection[] = [
	{
		...
		items: [
			{
				name: "Eggs Benedict",
				desc: "Œufs bénédictine sur muffins anglais avec bacon et sauce hollandaise",
				price: "11,90€",
			},
			{
				name: "Eggs Florentine",
				desc: "Œufs bénédictine sur muffins anglais avec épinards et sauce hollandaise. Ajouter saumon fumé: 2,80€",
				price: "11,90€",
			},
			{
				name: "Œufs brouillés",
				desc: "Trois œufs biologiques brouillés avec jambon serrano, asperges et toast blanc aux graines",
				price: "11,50€",
			},
			{
				name: "Shakshuka",
				desc: "Shakshuka au four avec œufs biologiques, tomates, pois chiches, poivrons, oignon, fromage feta et coriandre",
				price: "11,50€",
			},
			{
				name: "Baba Ganoush sur toast",
				desc: "Baba Ganoush traditionnel avec aubergine rôtie, grenade, yaourt, menthe et tahini sur toast blanc aux graines",
				price: "10,90€",
			},
			{
				name: "Avocat sur toast",
				desc: "Toast blanc aux graines avec avocat tranché, tomates cerises et huile d'olive vierge extra. Ajouter jambon serrano: 1,50€",
				price: "10,90€",
			},
			{
				name: "Breakfast tacos",
				desc: "Œufs brouillés avec avocat, oignon mariné, tomate, citron vert et crème fraîche au jalapeño",
				price: "11,50€",
			},
			{
				name: "Pancakes",
				desc: "Avec fruits frais et sirop d'érable",
				price: "10,50€",
			},
		],
	},
...
export const vinosEsSections: MenuSection[] = [
	{
		...
		items: [
			{
				name: "CASTELL DE FADES D.O. Conca de Barberà",
				subtitle: "Viognier · Ecológico",
				desc: "Fruta blanca y sutiles notas de fruta tropical (piña fresca)",
				price: "copa 3,50€ / 19,00€",
			},
			{
				name: "VIÑA SANZO D.O. Rueda",
				subtitle: "Verdejo · Ecológico",
				desc: "Seco, aromático, persistente",
				price: "copa 3,90€ / 23,00€",
			},
			{
				name: "CLOS DE COSTA D.O. Catalunya",
				subtitle: "Chardonnay",
				desc: "Afrutado con notas de pera, piña y cítricos",
				price: "copa 3,90€ / 23,00€",
			},
		],
	},
	{
		...
		items: [
			{
				name: "CLOS DE DÍA D.O. Terra Alta",
				subtitle: "Garnacha roja",
				desc: "Fácil de beber, afrutado, tanino sutil",
				price: "copa 3,50€ / 19,00€",
			},
			{
				name: "VEGA CASCAJO Crianza D.O. Rioja",
				subtitle: "Tempranillo",
				desc: "Agradable Rioja con notas de fruta roja madura y regaliz",
				price: "copa 3,90€ / 23,00€",
			},
			{
				name: "SANZO T-3 D.O. Terra Alta",
				subtitle: "Tempranillo",
				desc: "Color rojo intenso. Fruta madura con toques de vainilla",
				price: "copa 3,90€ / 23,00€",
			},
		],
	},
	{
		...
		items: [
			{
				name: "DOMINIO DEL DUEÑO V. Benavente",
				subtitle: "Tempranillo",
				desc: "Alegres notas de fruta roja",
				price: "copa 3,90€ / 23,00€",
			},
		],
	},
	{
		...
		items: [
			{
				name: "CAVA MO Brut Nature",
				subtitle: "Xarel·lo, Macabeo, Parellada",
				desc: "Burbuja equilibrada, aromas afrutados",
				price: "copa 3,50€ / 23,00€",
			},
			{
				name: "CAVA Dignitat Brut Rosé",
				subtitle: "Xarel·lo, Macabeo, Parellada",
				desc: "Cava muy agradable con notas finas y sedosas de fruta roja fresca",
				price: "copa 3,90€ / 25,00€",
			},
		],
	},
];
...
export const vinosEnSections: MenuSection[] = [
	{
		...
		items: [
			{
				name: "CASTELL DE FADES D.O. Conca de Barberà",
				subtitle: "Viognier · Ecologic",
				desc: "White fruit and subtle notes of tropical fruit (fresh pineapple)",
				price: "glass 3,50€ / 19,00€",
			},
			{
				name: "VIÑA SANZO D.O. Rueda",
				subtitle: "Verdejo · Ecologic",
				desc: "Dry, aromatic, persistent",
				price: "glass 3,90€ / 23,00€",
			},
			{
				name: "CLOS DE COSTA D.O. Catalunya",
				subtitle: "Chardonnay",
				desc: "Fruity with notes of pear, pineapple, and citrus",
				price: "glass 3,90€ / 23,00€",
			},
		],
	},
		...
		items: [
			{
				name: "CLOS DE DÍA D.O. Terra Alta",
				subtitle: "Garnacha roja",
				desc: "Easy to drink, fruity, subtle tannin",
				price: "glass 3,50€ / 19,00€",
			},
			{
				name: "VEGA CASCAJO Crianza D.O. Rioja",
				subtitle: "Tempranillo",
				desc: "Pleasant Rioja with notes of ripe red fruit and licorice",
				price: "glass 3,90€ / 23,00€",
			},
			{
				name: "SANZO T-3 D.O. Terra Alta",
				subtitle: "Tempranillo",
				desc: "Intense red color. Ripe fruit with hints of vanilla",
				price: "glass 3,90€ / 23,00€",
			},
		],
	},
		...
		items: [
			{
				name: "DOMINIO DEL DUEÑO V. Benavente",
				subtitle: "Tempranillo",
				desc: "Cheerful notes of red fruit",
				price: "glass 3,90€ / 23,00€",
			},
		],
	},
		...
		items: [
			{
				name: "CAVA MO Brut Nature",
				subtitle: "Xarel·lo, Macabeo, Parellada",
				desc: "Balanced bubble, fruity aromas",
				price: "glass 3,50€ / 23,00€",
			},
			{
				name: "CAVA Dignitat Brut Rosé",
				subtitle: "Xarel·lo, Macabeo, Parellada",
				desc: "Very pleasant cava with fine and silky notes of fresh red fruit",
				price: "glass 3,90€ / 25,00€",
			},
		],
	},
];
...
export const vinosCaSections: MenuSection[] = [
	{
		...
		items: [
			{
				name: "CASTELL DE FADES D.O. Conca de Barberà",
				subtitle: "Viognier · Ecològic",
				desc: "Fruita blanca i subtils notes de fruita tropical (pinya fresca)",
				price: "copa 3,50€ / 19,00€",
			},
			{
				name: "VIÑA SANZO D.O. Rueda",
				subtitle: "Verdejo · Ecològic",
				desc: "Sec, aromàtic, persistent",
				price: "copa 3,90€ / 23,00€",
			},
			{
				name: "CLOS DE COSTA D.O. Catalunya",
				subtitle: "Chardonnay",
				desc: "Afruitat amb notes de pera, pinya i cítrics",
				price: "copa 3,90€ / 23,00€",
			},
		],
	},
	{
		...
		items: [
			{
				name: "CLOS DE DÍA D.O. Terra Alta",
				subtitle: "Garnatxa roja",
				desc: "Fàcil de beure, afruitat, taní subtil",
				price: "copa 3,50€ / 19,00€",
			},
			{
				name: "VEGA CASCAJO Crianza D.O. Rioja",
				subtitle: "Tempranillo",
				desc: "Agradable Rioja amb notes de fruita vermella madura i regalèssia",
				price: "copa 3,90€ / 23,00€",
			},
			{
				name: "SANZO T-3 D.O. Terra Alta",
				subtitle: "Tempranillo",
				desc: "Color vermell intens. Fruita madura amb tocs de vainilla",
				price: "copa 3,90€ / 23,00€",
			},
		],
	},
		...
		items: [
			{
				name: "DOMINIO DEL DUEÑO V. Benavente",
				subtitle: "Tempranillo",
				desc: "Alegres notes de fruita vermella",
				price: "copa 3,90€ / 23,00€",
			},
		],
	},
		...
		items: [
			{
				name: "CAVA MO Brut Nature",
				subtitle: "Xarel·lo, Macabeo, Parellada",
				desc: "Bombolla equilibrada, aromes afruitats",
				price: "copa 3,50€ / 23,00€",
			},
			{
				name: "CAVA Dignitat Brut Rosé",
				subtitle: "Xarel·lo, Macabeo, Parellada",
				desc: "Cava molt agradable amb notes fines i sedoses de fruita vermella fresca",
				price: "copa 3,90€ / 25,00€",
			},
		],
	},
...
export const vinosFrSections: MenuSection[] = [
	{
		...
		items: [
			{
				name: "CASTELL DE FADES D.O. Conca de Barberà",
				subtitle: "Viognier · Biologique",
				desc: "Fruits blancs et subtiles notes de fruits tropicaux (ananas frais)",
				price: "verre 3,50€ / 19,00€",
			},
			{
				name: "VIÑA SANZO D.O. Rueda",
				subtitle: "Verdejo · Biologique",
				desc: "Sec, aromatique, persistant",
				price: "verre 3,90€ / 23,00€",
			},
			{
				name: "CLOS DE COSTA D.O. Catalunya",
				subtitle: "Chardonnay",
				desc: "Fruité avec des notes de poire, d'ananas et d'agrumes",
				price: "verre 3,90€ / 23,00€",
			},
		],
	},
		...
		items: [
			{
				name: "CLOS DE DÍA D.O. Terra Alta",
				subtitle: "Garnacha roja",
				desc: "Facile à boire, fruité, tanin subtil",
				price: "verre 3,50€ / 19,00€",
			},
			{
				name: "VEGA CASCAJO Crianza D.O. Rioja",
				subtitle: "Tempranillo",
				desc: "Agréable Rioja avec des notes de fruits rouges mûrs et de réglisse",
				price: "verre 3,90€ / 23,00€",
			},
			{
				name: "SANZO T-3 D.O. Terra Alta",
				subtitle: "Tempranillo",
				desc: "Couleur rouge intense. Fruits mûrs avec des touches de vanille",
				price: "verre 3,90€ / 23,00€",
			},
		],
	},
		...
		items: [
			{
				name: "DOMINIO DEL DUEÑO V. Benavente",
				subtitle: "Tempranillo",
				desc: "Joyeuses notes de fruits rouges",
				price: "verre 3,90€ / 23,00€",
			},
		],
	},
		...
		items: [
			{
				name: "CAVA MO Brut Nature",
				subtitle: "Xarel·lo, Macabeo, Parellada",
				desc: "Bulle équilibrée, arômes fruités",
				price: "verre 3,50€ / 23,00€",
			},
			{
				name: "CAVA Dignitat Brut Rosé",
				subtitle: "Xarel·lo, Macabeo, Parellada",
				desc: "Cava très agréable avec des notes fines et soyeuses de fruits rouges frais",
				price: "verre 3,90€ / 25,00€",
			},
		],
	},
];
...
export const cocktailsCaSections: MenuSection[] = [
	{
		...
		items: [
			...
			{
				name: "Café Martini",
				desc: "Vodka, sucre, licor de cafè, cafè",
				price: "6,00€",
			},
			{
...
export const cocktailsFrSections: MenuSection[] = [
	{
		...
		items: [
			...
			{
				name: "Café Martini",
				desc: "Vodka, sucre, liqueur de café, café",
				price: "6,00€",
			},
			{
				name: "Gin Basil Smash",
			...
			{
				name: "Caipirinha",
				desc: "Cachaça, sucre, citron vert",
				price: "6,00€",
			},
			{
				name: "Aperol Spritz",
