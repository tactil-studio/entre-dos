			...
			<div className="max-w-7xl mx-auto px-6">
				<div className="grid md:grid-cols-2 gap-10 md:gap-16 items-center">
					<div className={`relative reveal-left ${isVisible ? "visible" : ""}`}>
						...
						/>
						<div className="absolute -bottom-5 -right-3 md:right-6 bg-background border border-foreground/10 px-6 py-4 shadow-lg">
							<span className="block font-heading font-light text-4xl md:text-5xl text-foreground leading-none">
								14,90€
							</span>
						</div>
					</div>
