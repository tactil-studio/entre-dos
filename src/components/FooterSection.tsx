      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="grid md:grid-cols-3 gap-16 mb-16">
          ...
          <div>
            ...
            <div className="space-y-4 text-primary-foreground/60 font-body text-sm">
        ...
        <div className="border-t border-primary-foreground/10 pt-8 text-center">
          <p className="text-primary-foreground/30 text-xs font-body tracking-widest uppercase">
